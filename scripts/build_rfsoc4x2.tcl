#==============================================================================
# NX-MIMOSA — Vivado Build Script for RFSoC 4x2
...
puts "=============================================="
puts "NX-MIMOSA Build for RFSoC 4x2"
...
# Constraints
set constraints_file ./build_rfsoc4x2/${project_name}.srcs/constrs_1/new/timing.xdc
file mkdir [file dirname $constraints_file]
set fp [open $constraints_file w]
puts $fp "# NX-MIMOSA Timing Constraints - RFSoC 4x2 @ 250 MHz"
...
write_hw_platform -fixed -include_bit -force ./nx_mimosa_rfsoc4x2.xsa

puts "=============================================="
puts "Build complete!"
puts "Bitstream: nx_mimosa_rfsoc4x2.bit"
puts "XSA: nx_mimosa_rfsoc4x2.xsa (PYNQ)"
puts "=============================================="
